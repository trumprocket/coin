# Support for Output Descriptors in TrumpRocket Core

Since TrumpRocket Core v0.17, there is support for Output Descriptors. This is a
...
on TrumpRocket's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing TrumpRocket Core wallets, a convenience function `combo` is
