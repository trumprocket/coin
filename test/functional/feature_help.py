...
"""Verify that starting trumprocket with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start trumprocket with -h for help text")
        ...
        self.log.info("Start trumprocket with -version for version information")
        ...
        self.log.info("Start trumprocketd with -fakearg to make sure it does not start")
