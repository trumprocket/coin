...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " trumprocket-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  trumprocket-tx [options] <hex-tx> [commands]  Update hex-encoded trumprocket transaction\n" +
            "or:     trumprocket-tx [options] -create [commands]   Create hex-encoded trumprocket transaction\n" +
            "\n";
